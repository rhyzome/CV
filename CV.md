...
#### **Assistant Driller**                                                                                                           **Oct. 2014 – Jan. 2015**
...
- **Programming/scripting:** Python, Javascript, Lua, bash shell (regex, grep, sed/awk, dataflow pipes, etc.)
...
**More specific recent areas of interest:** 
